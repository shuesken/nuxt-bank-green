    ...
    <div class="contain py-10">
        <div class="text-center relative">
            ...
            <svg class="mx-auto relative z-1" width="119" height="51" viewBox="0 0 119 51" fill="none"
                ...
                <path d="M53.5 24.3603L59.9413 30.8015L71.5 19.2428" stroke="white" stroke-width="2.5"
                    stroke-linecap="round" stroke-linejoin="round" />
            </svg>

            <h1 v-if="title" class="mt-8 text-2xl font-semibold whitespace-pre-line mb-8">
                {{ title }}
            </h1>
    ...
    <div class="relative py-8 sm:py-16 bg-sushi-100">
        <div class="contain sm:text-center">
            <h4 class="font-semibold text-xl text-gray-800 mb-6 sm:text-2xl tracking-wide">
                {{ $t('BANK_ON_BETTER_FUTURE') }}
            </h4>
            <p class="text-gray-500 mb-6">{{ $t('NOT_HAPPY_EXPLORE') }}</p>
