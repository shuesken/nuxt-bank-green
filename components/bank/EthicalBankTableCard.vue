<template>
    <router-link
        ...
        class="rounded-2xl shadow-sm bg-white transition duration-150 ease-in-out hover:bg-gray-50 border border-transparent hover:border-sushi-500"
    >
        <div
        ...
        >
            ...
            >
                <div v-if="item" class="flex items-center truncate">
                    ...
                    <div
                        class="ml-3 flex-1 font-semibold text-gray-800 block truncate"
                    >
                        {{ item.name }}
                    </div>
                </div>
                ...
                <div v-else class="w-full flex items-center truncate">
                    <div
                        class="w-12 h-12 bg-gray-100 rounded-xl animate-pulse"
                    ></div>
                    <div
                        class="ml-3 flex-1 font-semibold text-gray-200 block truncate"
                    >
                        loading...
                    </div>
                </div>
