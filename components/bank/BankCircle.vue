<template>
    <div ref="container" class="w-full">
        <div
            class="shadow-circle bg-white rounded-full relative"
        ...
        >
            ...
            <svg
                ...
                :width="circleSize * 0.8 * 0.91"
                :height="circleSize * 0.8 * 0.69"
                viewBox="0 0 91 69"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <svg
                ...
                :width="circleSize * 0.4 * 0.21"
                :height="circleSize * 0.4 * 0.79"
                viewBox="0 0 21 79"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            >
