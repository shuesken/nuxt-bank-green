<template>
    <router-link
        ...
        class="flex items-center justify-between rounded-2xl shadow-sm bg-white transition duration-150 ease-in-out hover:bg-gray-50 border border-transparent hover:border-sushi-500 py-3 pl-4 pr-5"
    >
        <transition
