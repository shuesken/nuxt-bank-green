<template>
    <div v-if="showBanner" class="py-2 sm:px-0 bg-gray-900 text-gray-100 text-xs fixed bottom-0 inset-x-0 z-50">
        <div class="contain mx-auto">
            <div class="sm:flex justify-between items-center">
                <div class="text-gray-200 text-xs flex-1 mr-4" v-t="'COOKIE_MESSAGE'"></div>
                <div class="mt-1 sm:mt-0 flex items-center justify-between">
                    <NuxtLink to="/privacy"
                        ...
                        v-t="'IMPRINT_PRIVACY_SHORT'"></NuxtLink>
                    <div @click="noCookies"
