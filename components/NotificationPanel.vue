                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            <div v-if="notif.icon" class="flex-shrink-0">
                                <svg v-if="notif.icon === 'check'" class="h-6 w-6 text-green-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <svg v-else-if="notif.icon === 'lock-closed'" class="h-6 w-6 text-red-400" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg>
                                <svg v-else-if="notif.icon === 'x-circle'" class="h-6 w-6 text-red-400" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-3 w-0 flex-1 pt-0_5">
                                ...
                                <p v-if="notif.description" class="mt-1 text-sm leading-5 text-gray-500">
                                    {{ notif.description }}
                                </p>
                            </div>
