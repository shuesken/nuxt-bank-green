            ...
            <div class="page-fade-in contain pb-8 sm:pb-10 md:pb-12 pt-24 sm:pt-32">
                <div class="max-w-3xl mx-auto mt-4 mb-8 sm:text-center">
                    <h1 class="text-2xl sm:text-5xl font-extrabold text-sushi-900 mb-4">
                        A Brief Guide to the Latest IPCC Report on Climate
                        Change
                    </h1>
                    <span class="text-base text-gray-700 font-semibold">
                        August 20, 2021 by Neil Simpson
                    </span>
                </div>
                <article class="flex flex-col justify-center items-center">
                    <div class="prose sm:prose-lg xl:prose-xl break-words" v-html="contentBody"></div>
                </article>
            </div>
        </div>
...
<script>
import contentBody from './ipcc-report-climate-change.md'
...
export default {
    ...
    setup() {
        ...
        useHead({
            title: 'A Brief Guide to the Latest IPCC Report on Climate Change',
            description:
            ...
            image: '/img/uploads/ipcc-report-climate-change-image2.jpg',
        })
        const checkList = [
